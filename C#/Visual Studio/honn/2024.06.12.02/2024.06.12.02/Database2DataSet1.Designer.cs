...
namespace ASP._2024._06._12._02._2024._06._12._02 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int Id, string Category, string Maker, string Name, int Price) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Maker {
                get {
                    return ((string)(this[this.tableTable.MakerColumn]));
                }
                set {
                    this[this.tableTable.MakerColumn] = value;
                }
            }
...
namespace ASP._2024._06._12._02._2024._06._12._02.Database2DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Category] = @Origina" +
                "l_Category) AND ([Maker] = @Original_Maker) AND ([Name] = @Original_Name) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Category], [Maker], [Name], [Price]) VALUES (@I" +
                "d, @Category, @Maker, @Name, @Price);\r\nSELECT Id, Category, Maker, Name, Price F" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Category] = @Category, [Maker] = @Maker, [Name] = @Name, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([Category] = @Original_Category) AND ([Maker] = @Original_Maker) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price));
SELECT Id, Category, Maker, Name, Price FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ASP.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Category, Maker, Name, Price FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Category, string Original_Maker, string Original_Name, int Original_Price) {
        ...
        public virtual int Insert(int Id, string Category, string Maker, string Name, int Price) {
        ...
        public virtual int Update(int Id, string Category, string Maker, string Name, int Price, int Original_Id, string Original_Category, string Original_Maker, string Original_Name, int Original_Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Category, string Maker, string Name, int Price, int Original_Id, string Original_Category, string Original_Maker, string Original_Name, int Original_Price) {
            return this.Update(Original_Id, Category, Maker, Name, Price, Original_Id, Original_Category, Original_Maker, Original_Name, Original_Price);
        }
    }
